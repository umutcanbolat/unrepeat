...
- Rename the returned repeated pattern field from `repeated` to `pattern`.
- Require Node.js 20 or later.
- Publish as an ESM-only package.

### Features

- Add GitHub Actions CI and npm Trusted Publishing release workflow.
- Modernize package tooling with pnpm, Vitest, TypeScript, and Prettier.

### Code Improvements

- Simplify the repeat detection implementation.
- Refresh README and release documentation.
